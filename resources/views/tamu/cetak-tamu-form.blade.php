            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    <div class="input-group d-flex justify-content-between">
                        <a href="" onClick="this.href='/cetak-tamu-tanggal/'+document.getElementById('tanggalAwal').value +
                        '/' +document.getElementById('tanggalAkhir').value" 
                        target="_blank" class="btn btn-primary" style="color: #fff">Cetak Laporan 
                            <i class="fas fa-print"></i>
                        </a>
                        <a href="{{ route('element') }}" class="btn btn-primary ml-auto" style="color: #fff">Kembali ke Halaman Tamu</a>
                    </div>
                </div>
            </div>
